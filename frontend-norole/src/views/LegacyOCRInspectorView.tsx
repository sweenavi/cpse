...
export function LegacyOCRInspectorView({ currentUser, onNavigateTab }: LegacyOCRInspectorProps) {
  ...
  return (
    <div className="space-y-4 max-w-[1600px] mx-auto">
      ...
      {viewMode === 'DASHBOARD' ? (
        <>
          {/* STANDARDIZED 5-CARD KPI METRIC BAR */}
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3.5">
            <div
              onClick={() => setViewMode('EXTRACTED_RECORDS')}
              className="bg-white border border-slate-200/80 rounded-xl p-4 shadow-2xs flex flex-col justify-between cursor-pointer hover:border-blue-300 transition-all"
            >
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold text-slate-500">Total Legacy Docs</span>
              ...
              <div className="mt-3">
                ...
                <div className="text-[11px] text-slate-500 mt-0.5">Scanned Blueprints &amp; PDFs</div>
              </div>
            </div>

            <div
              onClick={() => setViewMode('EXTRACTED_RECORDS')}
              className="bg-white border border-slate-200/80 rounded-xl p-4 shadow-2xs flex flex-col justify-between cursor-pointer hover:border-emerald-300 transition-all"
            >
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold text-slate-500">Extraction Completed</span>
                <div className="w-8 h-8 rounded-lg bg-emerald-50 text-emerald-700 flex items-center justify-center">
                  <CheckCircle2 className="w-4 h-4" />
                </div>
              </div>
              <div className="mt-3">
                <div className="text-2xl font-black text-emerald-600 tracking-tight">1,108 Docs</div>
                <div className="text-[11px] text-emerald-600 font-semibold mt-0.5">99.2% Token Accuracy</div>
              </div>
            </div>

            <div className="bg-white border border-slate-200/80 rounded-xl p-4 shadow-2xs flex flex-col justify-between">
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold text-slate-500">In OCR Queue</span>
                <div className="w-8 h-8 rounded-lg bg-purple-50 text-purple-700 flex items-center justify-center">
                  <RefreshCw className="w-4 h-4" />
                </div>
              </div>
              <div className="mt-3">
                <div className="text-2xl font-black text-slate-900 tracking-tight">32 Files</div>
                <div className="text-[11px] text-slate-500 mt-0.5">LayoutLMv3 Processing</div>
              </div>
            </div>

            <div
              onClick={() => setViewMode('EXTRACTED_RECORDS')}
              className="bg-white border border-slate-200/80 rounded-xl p-4 shadow-2xs flex flex-col justify-between cursor-pointer hover:border-amber-300 transition-all"
            >
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold text-slate-500">Needs Validation</span>
                <div className="w-8 h-8 rounded-lg bg-amber-50 text-amber-700 flex items-center justify-center">
                  <AlertTriangle className="w-4 h-4" />
                </div>
              </div>
              <div className="mt-3">
                <div className="text-2xl font-black text-amber-600 tracking-tight">214 Items</div>
                <div className="text-[11px] text-amber-700 font-semibold mt-0.5">Awaiting HITL Review</div>
              </div>
            </div>

            <div
              onClick={() => setViewMode('EXTRACTED_RECORDS')}
              className="bg-white border border-slate-200/80 rounded-xl p-4 shadow-2xs flex flex-col justify-between cursor-pointer hover:border-indigo-300 transition-all"
            >
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold text-slate-500">Unified Records Created</span>
                <div className="w-8 h-8 rounded-lg bg-indigo-50 text-indigo-700 flex items-center justify-center">
                  <Database className="w-4 h-4" />
                </div>
              </div>
              <div className="mt-3">
                <div className="text-2xl font-black text-slate-900 tracking-tight">9,842</div>
                <div className="text-[11px] text-slate-500 mt-0.5">Mapped to National Masters</div>
              </div>
            </div>
          </div>
