          ...
          <div className="p-3.5 border-b border-slate-100 space-y-2.5 bg-slate-50/50">
            ...
            <div className="flex gap-1 bg-slate-200/70 p-1 rounded-lg text-xs font-semibold">
              <button
                ...
                className={`flex-1 py-1.5 rounded-md cursor-pointer text-center text-[11px] ${
                  activeQueueTab === 'QUEUE' ? 'bg-white shadow-xs text-blue-700 font-bold' : 'text-slate-600'
                }`}
              >
                All Cases (184)
              </button>
              <button
                ...
                className={`flex-1 py-1.5 rounded-md cursor-pointer text-center text-[11px] ${
                  activeQueueTab === 'ASSIGNED' ? 'bg-white shadow-xs text-blue-700 font-bold' : 'text-slate-600'
                }`}
              >
                My Assigned (12)
              </button>
                  ...
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <span
                      className={`text-[9px] font-bold px-2 py-0.5 rounded-full ${
                        item.priority === 'High' ? 'bg-rose-100 text-rose-800 border border-rose-200' : 'bg-amber-100 text-amber-800 border border-amber-200'
                      }`}
                    >
                ...
                <div className="flex items-center gap-1.5 mt-3 bg-slate-100 p-1 rounded-lg text-xs font-semibold">
                  <button
                    ...
                    className={`flex-1 py-1.5 rounded-md transition-all cursor-pointer text-center text-[11px] ${
                      workspaceTab === 'NOMENCLATURE' ? 'bg-white text-blue-700 shadow-xs font-bold' : 'text-slate-600 hover:text-slate-900'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 py-1.5 rounded-md transition-all cursor-pointer text-center text-[11px] ${
                      workspaceTab === 'AFFIRMATION_DECISION' ? 'bg-white text-blue-700 shadow-xs font-bold' : 'text-slate-600 hover:text-slate-900'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 py-1.5 rounded-md transition-all cursor-pointer text-center text-[11px] ${
                      workspaceTab === 'STANDARDS' ? 'bg-white text-blue-700 shadow-xs font-bold' : 'text-slate-600 hover:text-slate-900'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 py-1.5 rounded-md transition-all cursor-pointer text-center text-[11px] ${
                      workspaceTab === 'AUDIT' ? 'bg-white text-blue-700 shadow-xs font-bold' : 'text-slate-600 hover:text-slate-900'
                    }`}
                  >
                    Audit History
                  </button>
                    ...
                    <div className="bg-white border border-slate-200 rounded-xl p-4 space-y-3 shadow-2xs">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 text-xs font-semibold">
                        <label className={`p-3 rounded-lg border cursor-pointer flex items-center gap-2 transition-all ${
                          decision === 'EQUIVALENT' ? 'bg-emerald-50 border-emerald-400 text-emerald-900' : 'bg-slate-50 border-slate-200 hover:bg-slate-100'
                        }`}>
                        ...
                        <label className={`p-3 rounded-lg border cursor-pointer flex items-center gap-2 transition-all ${
                          decision === 'NOT_EQUIVALENT' ? 'bg-rose-50 border-rose-400 text-rose-900' : 'bg-slate-50 border-slate-200 hover:bg-slate-100'
                        }`}>
                        ...
                        <label className={`p-3 rounded-lg border cursor-pointer flex items-center gap-2 transition-all ${
                          decision === 'NEEDS_INFO' ? 'bg-amber-50 border-amber-400 text-amber-900' : 'bg-slate-50 border-slate-200 hover:bg-slate-100'
                        }`}>
